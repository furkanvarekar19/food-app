  ...
  return (
    <div className="text-gray-600 body-font w-[80%] mx-auto mt-[100px]">
      <div className="px-[16px]">
        <h2 className="title-font sm:text-4xl text-3xl md-4 font-medium text-gray-900 mt-8 ">
          Driving the force of 
          <span className="text-[#fbc531]">assortment</span>
        </h2>
        <p className="md-8 leading-relaxed text-[24px]">
      ...
      <div className="container max-auto flex px-5 py-24 md:flex-row flex-col items-center">
